...
body = "&".join([
    "_method=POST",
    f"data%5B_Token%5D%5Bkey%5D={quote(key.group(1), safe='')}",
...
r2 = s.post(f"{MISP_URL}/users/login", data=body, headers={"Content-Type":"application/x-www-form-urlencoded"}, allow_redirects=False, timeout=30)
