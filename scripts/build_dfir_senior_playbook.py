#!/usr/bin/env python3
"""Génère fp-dfir-senior-playbook.ndjson."""
...
NDJSON = OUT / "fp-dfir-senior-playbook.ndjson"
sys.path.insert(0, str(ROOT / "scripts"))

from build_opensearch_dashboards import dashboard, finalize_dashboard  # noqa: E402
from osd_dfir_senior_playbook_lib import DASH_ID, DASH_TITLE, append_searches, dashboard_panels  # noqa: E402
