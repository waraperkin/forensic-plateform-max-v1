#!/usr/bin/env python3
"""Génère fp-purple-team-playbook.ndjson."""
...
NDJSON = OUT / "fp-purple-team-playbook.ndjson"
sys.path.insert(0, str(ROOT / "scripts"))

from build_opensearch_dashboards import dashboard, finalize_dashboard  # noqa: E402
from osd_purple_team_playbook_lib import DASH_ID, DASH_TITLE, append_searches, dashboard_panels  # noqa: E402
