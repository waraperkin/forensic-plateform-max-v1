#!/usr/bin/env python3
"""Génère fp-soc-director-executive-playbook.ndjson."""
...
from osd_soc_director_executive_playbook_lib import DASH_ID, DASH_TITLE, append_searches, dashboard_panels  # noqa: E402
