#!/usr/bin/env python3
"""Génère fp-threat-hunting-lead-playbook.ndjson."""
...
NDJSON = OUT / "fp-threat-hunting-lead-playbook.ndjson"
sys.path.insert(0, str(ROOT / "scripts"))

from build_opensearch_dashboards import dashboard, finalize_dashboard  # noqa: E402
from osd_threat_hunting_lead_playbook_lib import DASH_ID, DASH_TITLE, append_searches, dashboard_panels  # noqa: E402
