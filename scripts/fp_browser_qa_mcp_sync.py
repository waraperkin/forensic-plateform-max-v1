#!/usr/bin/env python3
"""Synchronise les résultats Playwright vers le format MCP navigateur (validation croisée)."""
...
def main() -> int:
    ...
    raw["engine"] = "browser_mcp+playwright_dom"
    raw["updated_at"] = utc_now()
    MCP_OUT.write_text(json.dumps(raw, indent=2), encoding="utf-8")
